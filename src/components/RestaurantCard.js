...
function RestaurantCard(props) {
  ...
  const handleClick = () => {
    "/restaurant/" + props.resDetails.info.id;
    navigate("/restaurant/" + props.resDetails.info.id);
  };
  return (
    <div
      className="m-4 p-4 bg-gray-100 w-64 rounded-lg hover:bg-gray-200"
      onClick={handleClick}
    >
      <img
      ...
      <div className="m-4">
        ...
        <h4 className="bg-green-300 w-24">
          {props.resDetails.info.avgRating} stars ★
        </h4>
